...
class SearchingApp(App):
    ...
    def build_home_screen(self):
        ...
        search_btn.bind(on_press=(self.go_to_searching))
        return layout
    ...
    def build(self):
        ...
        self.sorting_screen.add_widget(Label(text="Search screen coming soon!"))

        self.search_screen = Screen(name="searching")
        self.search_screen.add_widget(self.build_searching_screen())
    ...
    def input_conversion(self, instance):
        ...
        try:
            ...
            if self.algorithm.text == "Binary Search":
